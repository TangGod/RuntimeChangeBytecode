 ...
 */
@Configuration
public class FeignRestTemplateConfiguration {
    ...
    public Feign.Builder feignBuilder() {
        return Feign.builder().requestInterceptor(new FeignRestTemplateInterceptor()).invocationHandlerFactory(invocationHandlerFactory());
    }
    ...
    public InvocationHandlerFactory invocationHandlerFactory() {
        return (target, dispatch) -> {
            FeignInvokerHandler handler = new FeignInvokerHandler();
